...
<div class="metadata-viewer-wrapper">
	...
	<div class="not-metadata-found hidden">
		...
		<h2><?php echo esc_html__( 'Sorry! No result found.', 'metadata-viewer' ); ?></h2>
		<p><?php echo esc_html__( 'No search result found for', 'metadata-viewer' ); ?> <strong class="search-meta-text"></strong>. <?php echo esc_html__( 'Please try another search.', 'metadata-viewer' ); ?></p>
	</div>
</div>
